...
def get_result(correct_chunks, true_chunks, pred_chunks,
    ...
    # for each chunck type, compuate precision, recall, and F1
    tagged_res = {}
    for t in chunk_types:
        p, r, f = calc_metrics(correct_chunks[t], pred_chunks[t], true_chunks[t])
        tagged_res[t] = (p, r, f)
    ...
    if verbose:
        ...
        print("\nprocessed %i tokens with %i phrases; " % (sum_true_counts, sum_true_chunks), end='')
        ...
        for t in chunk_types:
            prec, rec, f1 = tagged_res[t]
            print("%17s: " %t , end='')
            print("precision: %6.2f%%; recall: %6.2f%%; FB1: %6.2f" %
                        (prec, rec, f1), end='')
            print("  %d" % pred_chunks[t])

    return res, tagged_res
...
def evaluate(true_seqs, pred_seqs, verbose=True):
    ...
    result, tagged_result = get_result(correct_chunks, true_chunks, pred_chunks,
