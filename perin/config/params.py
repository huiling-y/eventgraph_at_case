...
class Params:
    def __init__(self):
        self.graph_mode = "labeled-edge"               # possibilities: {node-centric, labeled-edge}
    ...
    def init_data_paths(self):
        ...
        directory_2 = {
            ('case', 'all'): 'case_all',
            ('case', 'final'): 'case_final',
            ('case', 'all_split'): 'case_all_split',
            ('case', 'final_split'): 'case_final_split'
        ...
        if 'final' in self.language:
            self.validation_data = f"{self.data_directory}/{directory_1}/{directory_2}/train.mrp"
            self.raw_validation_data = f"{self.data_directory}/raw/{directory_2}/train.json"
        else:
