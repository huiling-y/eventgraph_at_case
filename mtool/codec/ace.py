    ...
    for native in json.load(fp):
        ...
        try:
            ...
            for event in native['events']:
                ...
                #properties, values = ["Polarity", "Genericity", "Modality"], [event["event_polarity"], event["event_genericity"], event["event_modality"]]
                ...
                if key in map:
                    print("We got double trigger here", native["sent_id"])
                map[key] = trigger 
